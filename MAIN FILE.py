...
def get_batch():
    with open(f'C:/python project/Batch.csv','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open(f'C:/python project/Student.csv','r+',newline='') as f:
        script=csv.reader(f)
...
while message:
    ...
    with open(f'{path}/Department.csv','a',newline='')as f:
        ...
        script.writerow(['CSEIOTCSBT','Computer Sience and Engineering and Internet of Things and Cyber security and Blockchain Technology'])
...
print('\n','Computer Sience and Engineering : CSE','\n',
      ...
      'Computer Sience and Engineering and Internet of Things and Cyber security and Blockchain Technology : CSEIOTCSBT','\n',
